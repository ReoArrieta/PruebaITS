...
@Component({
  selector: 'app-product-defective',
  templateUrl: './product-defective.component.html',
  styleUrls: ['./product-defective.component.scss']
})
export class ProductDefectiveComponent implements OnInit {
  ...
  read() {
    this._productService.readDefective().subscribe((res) => {
