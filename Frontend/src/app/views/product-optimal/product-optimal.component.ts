...
@Component({
  selector: 'app-product-optimal',
  templateUrl: './product-optimal.component.html',
  styleUrls: ['./product-optimal.component.scss']
})
export class ProductOptimalComponent implements OnInit {
  ...
  read() {
    this._productService.readOptimal().subscribe((res) => {
